...
import { CodeBracketsIcon, TerminalIcon, DatabaseIcon, LayersIcon } from '../components/DevIcons'
    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20">
      ...
      <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16">
        ...
        <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24">
          <AnimatedText text={content.about} className="text-[#D7E2EA] font-medium text-center leading-relaxed max-w-[560px]" style={{ fontSize: 'clamp(1rem, 2vw, 1.35rem)' }} />
          <ContactButton />
        </div>
      </div>
    </section>
