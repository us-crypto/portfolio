        ...
        {content.services.map((service, i) => (
          <FadeIn key={service.number} delay={i * 0.1}>
            <div
              ...
              style={i < content.services.length - 1 ? { borderBottom: '1px solid rgba(12, 12, 12, 0.15)' } : undefined}
            >
              ...
              <div className="flex flex-col gap-2 justify-center">
                ...
                <p className="font-light leading-relaxed max-w-2xl" style={{ fontSize: 'clamp(0.85rem, 1.6vw, 1.25rem)', color: '#0C0C0C', opacity: 0.6 }}>
                  {service.description}
                </p>
              </div>
            </div>
